...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="hospital-login.jsp" class="nav-item nav-link active">Hospital</a>
    ...
    <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white animated zoomIn">Hospital Login</h1>
                ...
                <nav aria-label="breadcrumb" class="small-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Hospital</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="row g-5 justify-content-center align-items-center">
        ...
        <!-- Image on the left -->
        <div class="col-lg-2">
            <img src="img/Screenshot (471).png" alt="Left Image" class="img-fluid rounded" style="max-height: 400px; width: 100%;">
        </div>

        <!-- Login form in the center -->
        <div class="col-lg-6">
            <div class="card p-4 shadow">
                <h3 class="mb-4">Hospital Login</h3>
                <form method="POST" id="myform" onsubmit="return validateuser()" action="hospital-loginAction.jsp" name="myform" class="contactForm">
                    <div class="mb-3">
        ...
        <!-- Image on the right -->
        <div class="col-lg-2">
            <img src="img/Screenshot (472).png" alt="Right Image" class="img-fluid rounded" style="max-height: 400px; width: 100%;">
        </div>
