    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            <div class="pcoded-main-container">
               ...
               <h2 class="mb-0 text-center"><b>Verified Using BlockChain</b></h2>                     
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" name="email" value="<%=rs.getString("emailHash")%>" readonly>
            </div>

            <div class="form-group">
                <label for="selfDisease">Self Disease:</label>
                <input type="text" class="form-control" id="selfDisease" name="selfDisease"  value="<%=rs.getString("sdHash")%>" readonly>
            </div>

            <div class="form-group">
                <label for="organsDonated">Organs Donated:</label>
                <input type="text" class="form-control" id="organsDonated" name="organsDonated" value="<%=rs.getString("odHash")%>" readonly>
            </div>
