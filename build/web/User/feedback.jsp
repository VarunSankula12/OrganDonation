    ...
    <link href="css/style.css" rel="stylesheet">
      <style>
        ...
        #navigation li.active a {
            color: #FFD700; /* Change this to the desired color */
        }
         .star-rating {
            margin: 25px 0 0px;
            font-size: 0;
    ...
    <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white animated zoomIn">Feedback</h1>
                ...
                <nav aria-label="breadcrumb" class="small-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"><a  class="text-white" href="feedback.jsp">Feedback</a></li>
                    </ol>
                </nav>
            </div>
