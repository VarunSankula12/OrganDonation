            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="status.jsp" class="nav-item nav-link active">My Status</a>
    ...
    <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white animated zoomIn">My Status</h1>
                ...
                <nav aria-label="breadcrumb" class="small-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page"><a  class="text-white" href="myStatus.jsp">My Status</a></li>
                    </ol>
                </nav>
            </div>
