  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="page-body">
            <div class="row">
                <div class="col-12">
    <h2 class="text-center mb-4" style="background-color: ">Welcome to Admin Dashboard</h2>
</div>
<%
    int tot=0;
    ...
    int pen=0;
    String q1="SELECT * FROM donation WHERE status='Pending'";
    ResultSet rs1=adminDao.Retrieve(q1);
    while(rs1.next()){
        pen++;
    }
    int fit=0;
    String q2="SELECT * FROM donation WHERE status='Fit'";
    ResultSet rs2=adminDao.Retrieve(q2);
    while(rs2.next()){
        fit++;
    }
    int unfit=0;
    String q3="SELECT * FROM donation WHERE status='Unfit'";
    ResultSet rs3=adminDao.Retrieve(q3);
    while(rs3.next()){
        unfit++;
    }
%>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            ...
                            <span class="text-c-pink f-w-600">Pending Users</span>
                            <h4><%=pen%></h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            ...
                            <span class="text-c-green f-w-600">Unfit Applications</span>
                            <h4><%=unfit%></h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            ...
                            <span class="text-c-yellow f-w-600">Fit Applications</span>
                            <h4><%=fit%></h4>
                            <div>
                            </div>
                        </div>
