                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Organ Donor's</b></h2>
                        </div>
                        <table class="table table-striped custab mt-2">
                            ...
                            <tbody>                  
                                <tr>
                                    ...
                                    <%
                                        if(!(rs.getString("status").equalsIgnoreCase("Fit"))){
                                    %>
                                    <td>Not Authorized</td>
                                    <%
                                        }else{
                                    %>
                                    <td><a href="blockChainVerification.jsp?email=<%=rs.getString("email")%>&self=<%=rs.getString("selfdisease")%>&od=<%=rs.getString("organsdonated")%>" class="btn btn-primary">BlockChain Verification</a></td>
                                    <%
                                        }
                                    %>
                                </tr>
