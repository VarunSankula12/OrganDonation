...
<body>
    ...
    <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white animated zoomIn">User Login</h1>
    ...
    <div class="card p-4 shadow">
        ...
        <form method="POST" id="myform" onsubmit="return validateuser()" action="user-loginAction.jsp" name="myform" class="contactForm">
            <div class="mb-3">
        ...
        <p class="mt-3">
            <small class="font-weight-bold">Don't have an account? <a class="text-primary" href="user-registration.jsp"><b>Register here</b></a> </small>
        </p>
    </div>
</div>
